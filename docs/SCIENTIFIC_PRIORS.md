...
Runtime version: `cognitive-priors-v1-2026-08`.
...
| Attention interruptions | Stothart et al. (2015), experiment, PMID [26121498](https://pubmed.ncbi.nlm.nih.gov/26121498/) | Small attention-domain prior. Aggregate digital load is not treated as a causal measure of cognition. |
...
- Attention and schedule loads are measured against prior personal medians.
