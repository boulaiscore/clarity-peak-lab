...
const showcaseSlides = [
  ...
  },
  {
    ...
    testimonialAuthor: "A. Morrison",
  },
  {
    image: phoneThinkingImage,
    headline: "Boost your intuition",
    metricType: "readiness" as const,
    metricValue: "76",
