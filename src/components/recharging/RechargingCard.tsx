...
export function RechargingCard() {
  ...
  return (
    <motion.button
      ...
      className="w-full p-4 rounded-xl bg-muted/30 border border-border/40 text-left transition-all duration-200 hover:bg-muted/50 hover:border-border/60 active:scale-[0.99]"
