...
const HALF_BRAIN_FOLDS: Record<ThinkingSystem, string[]> = {
  fast: [
    "M26 22 C34 18 46 16 58 18 C70 20 80 26 86 34",
    "M22 36 C32 32 44 30 56 32 C68 34 78 40 84 48",
    "M30 50 C40 46 52 44 64 46 C74 48 84 52 90 58",
  ],
  slow: [
    "M90 22 C82 18 70 16 58 18 C46 20 36 26 30 34",
    "M94 36 C84 32 72 30 60 32 C48 34 38 40 32 48",
    "M86 50 C76 46 64 44 52 46 C42 48 32 52 26 58",
  ],
};
