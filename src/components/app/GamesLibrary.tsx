...
const HALF_BRAIN_FOLDS: Record<ThinkingSystem, string[]> = {
  fast: [
    "M96 16 C86 12 72 10 60 12 C48 14 38 20 32 28",
    "M30 34 C42 30 56 28 68 32 C78 36 86 44 90 52",
    "M28 46 C40 42 54 44 66 50 C76 54 88 54 98 52",
  ],
  slow: [
    "M20 16 C30 12 44 10 56 12 C68 14 78 20 84 28",
    "M86 34 C74 30 60 28 48 32 C38 36 30 44 26 52",
    "M88 46 C76 42 62 44 50 50 C40 54 28 54 18 52",
  ],
};
