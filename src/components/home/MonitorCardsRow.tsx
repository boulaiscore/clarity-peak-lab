    ...
    >
      ...
      >
        <div className="flex items-center justify-between w-full mb-1">
          <span className="text-[8px] font-semibold uppercase tracking-[0.14em] text-foreground/65">
            Cognitive Monitor
          </span>
          <ChevronRight className="w-2.5 h-2.5 text-muted-foreground/60 group-hover:text-foreground/80 transition-colors" />
        </div>
        <div className="flex items-center gap-1.5">
          ...
          >
            {allInRange ? (
              ...
              <span className="text-[7px] font-bold text-amber-400 leading-none">{inRange}</span>
            )}
          </span>
          <div className="flex flex-col leading-tight">
            ...
            <span className="text-[8px] text-muted-foreground/70">{inRange}/4 Metrics</span>
          </div>
        </div>
      </button>
      ...
      >
        ...
        <div className="flex items-center gap-1.5">
          <span className="w-3.5 h-3.5 rounded bg-foreground/[0.06] flex items-center justify-center">
            <Activity className="w-2 h-2 text-foreground/70" />
          </span>
          <div className="flex flex-col leading-tight">
            <span className="text-[10px] font-semibold text-foreground/90 tracking-wide">
              {isLoading ? "—" : recLabel}
            </span>
            <span className="text-[8px] text-muted-foreground/70">{recValue} battery</span>
          </div>
        </div>
      </button>
    </motion.section>
