  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
          "group flex flex-col items-start text-left p-3 rounded-2xl",
          "bg-card/40 border border-border/40 hover:bg-card/60 hover:border-border/60",
          "transition-colors active:scale-[0.99]",
        )}
      >
        <div className="flex items-center justify-between w-full mb-2">
          <span className="text-[10px] font-semibold uppercase tracking-[0.14em] text-foreground/65">
            Cognitive Monitor
          </span>
          <ChevronRight className="w-3.5 h-3.5 text-muted-foreground/60 group-hover:text-foreground/80 transition-colors" />
        </div>
        <div className="flex items-center gap-2">
          ...
          >
            {allInRange ? (
              ...
              <span className="text-[9px] font-bold text-amber-400 leading-none">{inRange}</span>
            )}
          </span>
          <div className="flex flex-col leading-tight">
            ...
            <span className="text-[10px] text-muted-foreground/70">{inRange}/4 Metrics</span>
          </div>
        </div>
      </button>
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <span className="w-5 h-5 rounded-md bg-foreground/[0.06] flex items-center justify-center">
          ...
          <div className="flex flex-col leading-tight">
            ...
            <span className="text-[10px] text-muted-foreground/70">{recValue} battery</span>
          </div>
        </div>
      </button>
    </motion.section>
