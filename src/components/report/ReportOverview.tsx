  ...
  return (
    <section className="report-page">
      ...
      <p className="report-subtitle">
        {profile.name || "Participant"} completed the NeuroLoop Cognitive Assessment Battery (CAB) on {generatedAt.toLocaleDateString("en-GB", { day: "numeric", month: "long", year: "numeric" })}.
      </p>

      {/* Description Box */}
      <div className="overview-description">
        <h3>ABOUT THE NEUROLOOP COGNITIVE ASSESSMENT</h3>
        <p>
          The NeuroLoop Cognitive Assessment Battery (CAB) is a comprehensive neurocognitive evaluation system 
