        ...
        <div className="min-h-[350px] bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 text-white p-5 sm:p-10">
          ...
          <div className="flex items-center justify-between mb-8 sm:mb-12">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h1 className="text-lg sm:text-xl font-bold tracking-tight">NLOOP Pro</h1>
        ...
        <div className="p-6 bg-slate-800 text-white">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">NLOOP Pro</span>
            </div>
          ...
          <div className="text-xs text-white/50 leading-relaxed">
            <p className="mb-2">
              ...
              NLOOP's proprietary analysis algorithms based on user training data and performance metrics. 
