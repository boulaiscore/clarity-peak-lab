  ...
  return (
    <section className="report-page report-cover-medical">
      ...
      <div className="medical-header">
        <div className="medical-logo">
          ...
          <div className="logo-text">
            <span className="logo-name">Luma</span>
      ...
      <div className="medical-footer">
        <p>
          This cognitive assessment report is generated by Luma's proprietary analysis algorithms based on training performance data.
          Results are for educational and self-improvement purposes. This is not a clinical neuropsychological evaluation.
        </p>
        <div className="footer-meta">
          <span>Luma Pro v2.0</span>
          <span>•</span>
