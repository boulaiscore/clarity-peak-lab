...
export function useRecordGameSession() {
  ...
  return useCallback(async (params: {
    ...
    gameName?: "orbit_lock" | "triage_sprint" | "focus_switch" | "flash_connect" | "semantic_drift" | "constellation_snap" | "causal_ledger" | "counterfactual_audit" | "socratic_cross_exam" | "signal_vs_noise" | "hidden_rule_lab";
