...
export const NEURO_LAB_AREAS: NeuroLabAreaConfig[] = [
  {
    ...
    description: "Calibrate selective attention, visual search, and sustained concentration.",
    icon: "Target",
  },
  {
    id: "reasoning",
    ...
    description: "Structured protocols for logical analysis, bias detection, and deliberate reasoning.",
    icon: "Lightbulb",
  },
  {
    id: "creativity",
    ...
    description: "Protocols for divergent thinking, analogical reasoning, and conceptual reframing.",
    icon: "Sparkles",
  },
];
