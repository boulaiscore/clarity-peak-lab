  ...
  return (
    <AppShell>
      <div className="container px-4 py-6">
        ...
        {/* Session Duration Selection - Hidden for Critical Reasoning and Focus Arena */}
        {area !== "reasoning" && area !== "focus" && (
          <div className="mb-6">
        ...
        {/* Session Info - Hidden for Critical Reasoning and Focus Arena */}
        {area !== "reasoning" && area !== "focus" && (
