...
import { ArrowLeft, FlaskConical, Clock, Star, HelpCircle, X } from "lucide-react";
...
export default function HiddenRuleLabRunner() {
  ...
  const handleComplete = useCallback(async (
    ...
    const cleanLock = ruleCorrect && 
                      gameMetrics.testQualityScore >= 70 && 
                      gameMetrics.hypothesisSwitchCount <= 2;
          ...
          >
            ...
            <div className="flex items-center gap-3 p-4 border-b border-border/30">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold">Hidden Rule Lab</span>
              </div>
            </div>
              ...
              <div className="max-w-sm text-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Infer the rule. Test it. Lock it.
                  </p>
                </div>
                  ...
                  >
                    ...
                    <div className="space-y-3 text-sm text-muted-foreground">
                      <div className="flex gap-3">
                        ...
                        <p>
                          <strong className="text-foreground">Discover</strong> — Observe input→output examples and form a hypothesis.
                        </p>
                      </div>
                      <div className="flex gap-3">
                        <div className="w-6 h-6 rounded-full bg-violet-500/10 flex items-center justify-center shrink-0">
                        ...
                        <p>
                          <strong className="text-foreground">Test</strong> — Pick informative tests to separate hypotheses.
                        </p>
                      </div>
                      <div className="flex gap-3">
                        <div className="w-6 h-6 rounded-full bg-violet-500/10 flex items-center justify-center shrink-0">
                        ...
                        <p>
                          <strong className="text-foreground">Lock & Apply</strong> — Commit to your rule, then predict new outputs.
                        </p>
                      </div>
                    </div>
