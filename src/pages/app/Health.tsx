              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className={cn("text-sm font-medium", isSelected && "text-foreground")}>{device.name}</p>
                    {device.id === "other" && <p className="text-xs text-muted-foreground">Specify later</p>}
                  </div>
      ...
      <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
        <AlertDialogContent className="max-w-sm">
          <AlertDialogHeader>
            ...
            <AlertDialogTitle className="text-center">Join the waiting list?</AlertDialogTitle>
          ...
          <AlertDialogFooter className="sm:justify-center gap-2">
            <AlertDialogCancel onClick={handleCancelWaitlist}>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={handleConfirmWaitlist}>Notify me</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </AppShell>
